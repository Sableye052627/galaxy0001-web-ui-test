...
import { NotificationOutlined, TranslationOutlined, MobileOutlined, LockOutlined, CreditCardOutlined, PlayCircleOutlined, FireOutlined } from "@ant-design/icons";
    ...
    <div id="home-page">
      ...
      <Row className="about-us" justify="center">
        <Col {...gridSetting}>
          ...
          <div className="desc">{language === "bahasa" ? platformInfo?.descriptionMY : language === "mandarin" ? platformInfo?.descriptionCN : platformInfo?.descriptionEN}</div>
          ...
          <div className="game-category-content">
            {gpCategory?.map((items: any, index: number) => (
              <div key={index} className="game-category-item">
                <img src={`https://game-platform.sgp1.digitaloceanspaces.com/win22/home-game-btn/${items.category}.png`} alt={items.category} />
              </div>
            ))}
          </div>
        </Col>
